...
with $X_y$ the calculated variable $X$ (ex. biomass or basal area) of the entity $y$ (tree, stump or deadwood) and $i,j,k$ the plot and subplot and entity number respectively (ex. plot 1, subplot 1A, tree 1).
