...
knitr::kable(tab$tbl_Nh, format.args = list(big.mark = ','))
...
knitr::kable(tab$tbl_access, format.args = list(big.mark = ','))
...
knitr::kable(tab$tbl_entity, format.args = list(big.mark = ','))
...
knitr::kable(tab$tbl_carbon, format.args = list(big.mark = ","))
...
\text{tree_weight} = 
  \begin{cases} 
    \text{4   when tree DBH} \le \text{30 cm} \\
    \text{1   when tree DBH > 30 cm} 
  \end{cases}
$$ {#eq-treeweight}
