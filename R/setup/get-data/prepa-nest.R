...
if (names(tmp$tree1)[15] != "t_height_dbh") names(tmp$tree1)[15] <- "t_height_dbh"
if (names(tmp$tree2)[15] != "t_height_dbh") names(tmp$tree2)[15] <- "t_height_dbh"
if (names(tmp$tree2)[24] != names(tmp$tree1)[24]) names(tmp$tree2)[24] <- names(tmp$tree1)[24]
